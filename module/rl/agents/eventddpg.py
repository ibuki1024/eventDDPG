...
from rl.eventcore import Agent
...
class eventDDPGAgent(Agent):
    ...
    def first_forward(self, observation):
        # Select an action.
    ...
    def forward(self, observation):
        ...
        action_candidate = self.select_action(state)[0]
        decision = self.select_action(state)[1:3]
