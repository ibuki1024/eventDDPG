...
def decide(x):
    """Decide whether to commnunicate or not.
    ...
    """
    print('ok')
    #get shape and compare the last two elements of x
    shape_of_x = x.shape[1]
    #how can we access to elements of tensor?
    if x[shape_of_x - 2] > x[shape_of_x - 1]:
        #decide to communicate. remove the last two elements.
        return NULL
    else :
        #decide not to communicate. return the last input.
        return NULL
