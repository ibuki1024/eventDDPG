...
from ..eventcore import event_Agent, event_safe_Agent
...
class eventDDPGAgent(event_Agent):
    """DDPG Agent for event trigger control.
    """
...
class event_safe_DDPGAgent(event_safe_Agent):
    """Write me
    """
    def __init__(self, nb_actions, actor, critic, critic_action_input, memory,
                 gamma=.99, batch_size=32, nb_steps_warmup_critic=1000, nb_steps_warmup_actor=1000,
