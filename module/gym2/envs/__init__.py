from gym2.envs.registration import registry, register, make, spec
...
register(
    id='Linear-v0',
    entry_point='gym2.envs.classic_control:LinearEnv',
    max_episode_steps=2000000000000,
)
...
register(
    id='Linear-v2',
    entry_point='gym2.envs.classic_control:LinearEnv5D',
    max_episode_steps=2000000000000,
)

register(
    id='Linear-v3',
    entry_point='gym2.envs.classic_control:LinearEnv4D',
    max_episode_steps=2000000000000,
)

register(
    id='Linear-v4',
    entry_point='gym2.envs.classic_control:LinearEnv3D',
    max_episode_steps=2000000000000,
)
